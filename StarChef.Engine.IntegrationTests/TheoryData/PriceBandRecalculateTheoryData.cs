...
namespace StarChef.Engine.IntegrationTests.TheoryData
{
    ...
    public class PriceBandRecalculateTheoryData : TheoryPriceData<PriceRecalculationRequest>
    {
        public PriceBandRecalculateTheoryData()
        {
            ...
            var items = customerDbRepository.GetPriceBands().ToList();
