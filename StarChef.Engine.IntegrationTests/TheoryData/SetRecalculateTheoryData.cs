...
namespace StarChef.Engine.IntegrationTests.TheoryData
{
    ...
    public class SetRecalculateTheoryData : TheoryPriceData<PriceRecalculationRequest>
    {
        public SetRecalculateTheoryData()
        {
            ...
            var items = customerDbRepository.GetSets().ToList();
            //List<int> excludeItems = new List<int>() { 1, 110, 236, 149 };
            //List<int> excludeItems = new List<int>() { };
            //List<int> inludeItems = new List<int>() { 356 };
            ...
            else
            {
                foreach (var item in items)
                {
                    ...
                    //if (inludeItems.Contains(item.GroupId))
                    //    Add(item);
                }
            }
        }
